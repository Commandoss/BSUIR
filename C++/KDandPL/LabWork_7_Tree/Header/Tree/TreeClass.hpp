...
#ifndef TreeClass_hpp
#define TreeClass_hpp
...
public:
    ...
    TreeNode<Type>* minKey(TreeNode<Type> *root);
    TreeNode<Type>* maxKey(TreeNode<Type> *root);
    TreeNode<Type>* searchTree(TreeNode<Type> *root, int value);
    TreeNode<Type>* freeNode(TreeNode<Type> *root, const int key);
    
    bool check_key(TreeNode<Type> *root, int newKey);
    bool print_key(TreeNode<Type> *root);
    
    void DestroyTree(TreeNode<Type> *root);
    void DestroyElemTree(TreeNode<Type> *root);
