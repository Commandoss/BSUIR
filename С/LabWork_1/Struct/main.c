...
struct textstatistics {
    float size_of_all_text_in_pixels;
    int quantily_interval_line;
    int max_size_paragraphs;
    float size_page; 
    int page_color;
    int price_per_sheet;
    float price_of_all_text;
    float number_of_sheets;
    int number_of_sheets_color;
